...
| Criterio                                                                                                                                      | Puntuación   |
|-----------------------------------------------------------------------------------------------------------------------------------------------|--------------|
| Despliegue manual de un `.war` en Tomcat                                                                                                      | **1 punto**      |
| Despliegue del `.war` de prueba utilizando maven                                                                                              | **0.25 puntos**  |
| Despliegue de una aplicación con maven desde un repositorio de Github                                                                         | **4.75 puntos** |
| Cuestiones                                                                                                                                    | **2 puntos**     |
