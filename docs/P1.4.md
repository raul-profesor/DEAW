# Práctica 1.4 – Balanceo de carga con proxy inverso en Nginx 

## Requisits abans de començar la pràctica

!!!danger "Atenció, muy importante antes de empezar"

    + La práctica 1.3 debe estar funcionando correctamente
    + No empezar la práctica antes de tener la 1.3 funcionando y ***comprobada*** 
...
Vamos a configurar dos servidores web Nginx con dos máquinas Ubuntu Server, además de reutilizar el proxy inverso Nginx configurado en la práctica anterior. Partiremos por tanto de la configuración de la práctica anterior, añadiendo lo necesario: 
...
+ Realizaremos las peticiones HTTP desde el navegador web de nuestro Xubuntu. 

El diagrama de red quedaría así: 

![](img/4.1-14.png)

Las tres máquinas estarán en nuestra red interna. Haremos las peticiones web desde el navegador al proxy inverso, que las repartirá entre los dos servidores web que tenemos. 
...
El primer servidor web será el servidor principal que hemos venido utilizando hasta ahora durante el curso, donde tenemos instaladoya el servicio Web. 
...
Debe ser una máquina Ubuntu Server con todos los servicios parados excepto Nginx. 
...
- El bloque upstream → son los servidores entre los que se va a repartir la carga, que son los dos que hemos configurado anteriormente. 
  ...
  * Si miráis el diagrama y tenéis en cuenta la configuración que habéis hecho hasta ahora, aquí deberéis colocar el nombre de cada servidor, así como el puerto donde está escuchando las peticiones web. 
...
| Criterio      | Puntuación                         |
| :--------- | :----------------------------------: |
|  Configuración correcta y completa del servidor web 1   |** puntos**  |
|  Configuración correcta y completa del servidor web 1   |** puntos**  |
